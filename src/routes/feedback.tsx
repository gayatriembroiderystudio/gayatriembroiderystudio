...
export const Route = createFileRoute("/feedback")({
  head: () => ({
    meta: [
      { title: "Reviews & Feedback — Gayatri Embroidery Studio" },
      {
        name: "description",
        content:
          "Read what our brides say, and leave your own review for Gayatri Embroidery Studio.",
      },
      { property: "og:title", content: "Customer Reviews — Gayatri Embroidery Studio" },
  ...
  return (
    <div>
      <PageHeader
        ...
        subtitle="Five-star moments stitched into memory."
      />
