...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Royal Boutique" },
      { property: "og:description", content: "Royal Boutique offers premium computerized embroidery, maggam, aari, zardosi & bridal designing in Jeypore, Odisha. Book your bespoke consultation." },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Royal Boutique" },
      { name: "twitter:description", content: "Royal Boutique offers premium computerized embroidery, maggam, aari, zardosi & bridal designing in Jeypore, Odisha. Book your bespoke consultation." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/d54020db-117f-4ac3-b92b-066de0a64730" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/d54020db-117f-4ac3-b92b-066de0a64730" },
    ],
    links: [
